...
class NewEventViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate  {
        ...
        didFinishPickingMediaWithInfo info: [String : AnyObject])
    {
        ...
        fotoBackground.contentMode = .ScaleAspectFill //3
        fotoBackground.layer.masksToBounds = true
    ...
    override func viewDidLoad() {
        ...
        dateFormatter2.timeZone = NSTimeZone(name: "BRST")
    ...
    @IBAction func saveButton(sender: AnyObject) {
        ...
        evento.saveInBackgroundWithBlock {
            ...
            if (success) {
                if self.hashtags!.lowercaseString.rangeOfString("esportes") != nil {
                    print("Evento ESPORTES criado!")
                    // Send a notification to all devices subscribed to the "Giants" channel.
                    let push = PFPush()
                    push.setChannel("Esportes")
                    push.setMessage("Há um novo evento na cidade. Venha conferir!")
