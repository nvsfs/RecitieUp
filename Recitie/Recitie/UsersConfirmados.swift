...
class UsersConfirmados : UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func loadCollectionViewData() {
        ...
        //print (currentObject)
        if let eventoAtual = currentObject{
            query.whereKey("Events", equalTo: eventoAtual)
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        if let value = users[indexPath.row]["first_name"] as? String {
            cell.cellTitle.text = value
        }else{
            cell.cellTitle.text = "Desconhecido"
        }
